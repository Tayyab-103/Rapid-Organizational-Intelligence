...
import { useColorModeValue } from '@mui/system';
...
const MembersTable = () => {
  ...
  const bgHover = useColorModeValue(
    { backgroundColor: 'secondaryGray.400' },
                      ...
                      <Collapse in={expandedRows[row._id]}>
                        ...
                        >
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            <Typography
                              variant='h6'
                              sx={{ fontWeight: 'bolder', marginRight: '5px' }}
                            >
                              Additional Info
                            </Typography>
                          ...
                          <TableContainer>
                            <Table
                              sx={{ minWidth: 650 }}
                              aria-label='additional info table'
                            >
                              <TableHead>
                                <TableRow>
